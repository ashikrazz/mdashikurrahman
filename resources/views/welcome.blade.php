            ...
            <div class="social-link-area">
                ...
                <ul>
                    <li>
                        ...
                        <a href="https://www.linkedin.com/in/md-ashikur-rahman-01522b401/" target="_blank"><i class="fa-brands fa-linkedin-in"></i></a>
                    </li>
                </ul>
            </div>
            <div class="space40"></div>
            ...
            <div class="col-lg-4">
                <div class="personal-contact-box" data-aos="fade-right" data-aos-duration="1000">
                    ...
                    <div class="btn-area1 text-center">
                        <a href="{{asset('assets/img/all-images/hero/My_Resume.pdf')}}" download class="vl-btn1">Download Now <img src="{{asset('assets/img/icons/download1.svg')}}" alt=""></a>
                    </div>
                    <div class="space32"></div>
